...
class SymbolSingleTransaction(p.MessageType):
    ...
    def get_fields(cls) -> Dict:
        return {
            ...
            19: ('account_address_restriction', SymbolAccountAddressRestriction, None),
            20: ('account_mosaic_restriction', SymbolAccountMosaicRestriction, None),
            21: ('account_operation_restriction', SymbolAccountOperationRestriction, None),
            22: ('mosaic_address_restriction', SymbolMosaicAddressRestriction, None),
            23: ('mosaic_global_restriction', SymbolMosaicGlobalRestriction, None),
        }
