...
static ENUM_DEFS: &[u8] = include_bytes!("../../../../src/trezor/enums/proto_enums.data");
static MSG_DEFS: &[u8] = include_bytes!("../../../../src/trezor/enums/proto_msgs.data");
static NAME_DEFS: &[u8] = include_bytes!("../../../../src/trezor/enums/proto_names.data");
static WIRE_DEFS: &[u8] = include_bytes!("../../../../src/trezor/enums/proto_wire.data");
